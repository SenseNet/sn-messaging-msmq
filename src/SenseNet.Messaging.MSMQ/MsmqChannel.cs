...
namespace SenseNet.Communication.Messaging
{
    ...
    public class MsmqChannelProvider : ClusterChannel
    {
        ...
        private readonly System.Messaging.BinaryMessageFormatter _formatter = new System.Messaging.BinaryMessageFormatter();
        ...
        public override string ReceiverName => _receiverName;
        ...
        public override bool RestartingAllChannels => _restartingAllChannels;
        ...
        public override void RestartAllChannels()
        {
            ...
            try
            {
                ...
                _receiveQueue.Close();
                foreach (var sendQueue in _sendQueues)
                    sendQueue.Close();
        ...
        private static Message CreateMessage(Stream messageBody)
        {
            var m = new Message(messageBody)
            {
                TimeToBeReceived = TimeSpan.FromSeconds(Configuration.Messaging.MessageRetentionTime)
            };
        ...
        protected override void InternalSend(Stream messageBody, bool debugMessage)
        {
